...
experience.textContent = developer.yearsExperience + " Years";
cardDiv.appendChild(experience);
experience.id = "experienceID";

//Active
const active = document.createElement("p");
active.textContent = developer.isActive;
